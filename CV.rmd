...
#### **US GROUNDWATER RESEARCH**, University of California, Santa Barbara, CA<br/>***Research assistant***, Professor Perrone, Debra **(2019 - present)**
...
#### **FLOOD MAPPING RESEARCH**, University of California, Santa Barbara, CA<br/>***Research assistant***, PhD candidate Johnson, Mike **(2019 - present)**
...
#### **INSTRUCTIONAL ASSISTANT**, University of California, Santa Barbara, CA<br/>***ENVS 193*** Professor Perrone, Debra **(Winter 2020)**
...
##### **Skills:**
  -	Experienced using R as a platform for GIS and data analysis:
    - Using **dplyr**, **tidyr**, **ggplot2**, **sp**, **sf**, and **leaflet** packages
